...
import static com.sinhvien.appdean.PlayerActivity.listSongs;
import static com.sinhvien.appdean.PlayerActivity.uri;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    void showNotification(int playPauseBtn){
        ...
        if(picture != null){
            ...
            thumb = BitmapFactory.decodeResource(getResources(), R.drawable.hinhne);
        }
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID_2)
                ...
                .setNotificationSilent()//Tat am thong bao
